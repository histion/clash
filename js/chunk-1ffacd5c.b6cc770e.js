        ...
        a9c7: function (e, t, o) {
            ...
            var n = function () {
                ...
                m = {
                                ...
                                options: {
                                    ...
                                    remoteConfig: [{
                                        ...
                                        options: [{
                                            ...
                                            label: "openclash",
                                            value: "https://raw.githubusercontent.com/histion/bcgz/config/config/openclash.ini"
                                        }, {
                    ...
                    created: function () {
                        document.title = "塞拉斯版ACL4SSR订阅转换", this.isPC = this.$getOS().isPc, this.form.sourceSubUrl = this.getLocalStorageItem("sourceSubUrl")
                    },
                    mounted: function () {
